...
public class DateUtils {
	...
	*//**
	...
	public static Date setDay(Date date, int dayAmount) {
		...
		return new DateTime(dateTime.getYear(), dateTime.getMonthOfYear(), dayAmount, dateTime.getHourOfDay(),
				dateTime.getMillisOfDay()).toDate();
	}
	...
	*//**
	 * 计算得到日期区间的所有日期 例如：from=2017-06-25 to=2017-06-28 那么他们之间的日期就是 2017-06-26
	 * 2017-06-27
	 *
	 * @param from
	 * @param to
	...
	*//**
	 * 计算得到日期区间的所有日期（包含开始日期） 例如：from=2017-06-25 to=2017-06-28 那么他们之间的日期就是
	...
	*//**
	 ...
	 *//*
	public static boolean checkDateRangeCross(Date firstBeginDate, Date firstEndDate, Date secondBeginDate,
			Date secondEndDate) {
	...
	*//**
	 ...
	 * @return 如果有交叉返回true 否则返回false
	 *//*
	public static boolean checkDateRangeCross(long firstBeginDate, long firstEndDate, long secondBeginDate,
			long secondEndDate) {
		return ((firstBeginDate >= secondBeginDate) && firstBeginDate < secondEndDate)
				|| ((firstBeginDate > secondBeginDate) && firstBeginDate <= secondEndDate)
				|| ((secondBeginDate >= firstBeginDate) && secondBeginDate < firstEndDate)
				|| ((secondBeginDate > firstBeginDate) && secondBeginDate <= firstEndDate);
	}
	...
	*//**
	 ...
	 *            星期几
	 * @param dateTime
	 *            具体时间 getDates("2013-04-01", "2014-04-14","星期一|星期二|星期日");
	 * @return 返回时间数组
	 *//*
